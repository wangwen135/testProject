...
public class MBeanDemo {
	...
	public static void showMemoryInfo() {
		...
		System.out.println("Heap committed:" + heap.getCommitted() + " init:"
				+ heap.getInit() + " max:" + heap.getMax() + " used:"
				+ heap.getUsed());
	}
	...
	public static void showCompilation() {
		...
		System.out.println("TotalCompilationTime:"
