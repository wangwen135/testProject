 ...
 * @since 1.0
 */
public class UnitEntity extends AbstractEntity implements IEntity {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2526951361626437131L;

	public static final String TYPE = "UnitEntity";
	...
	public void setValue(Object obj) {
		...
		if (strvalue.contains(";")) {// 多品名
			...
			if (arrayQuantity.length < 4) {
				this.value = EDIUtils.substringAfterDecimal(strvalue);// 非多品名，做单品名处理
			} else {
				this.value = arrayQuantity[1];
			}

		} else {
			this.value = EDIUtils.substringAfterDecimal(strvalue);
		}
	}
