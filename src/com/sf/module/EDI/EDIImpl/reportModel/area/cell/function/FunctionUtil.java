...
public class FunctionUtil {
	...
	static {// 增加新函数后需增加
		...
		functionsMap.put(CountFunction.TYPE, CountFunction.class);
		functionsMap.put(FillFunction.TYPE, FillFunction.class);
		functionsMap.put(SubstringFunction.TYPE, SubstringFunction.class);
		functionsMap.put(ReplaceFunction.TYPE, ReplaceFunction.class);
		functionsMap.put(JFConvertFunction.TYPE, JFConvertFunction.class);
		functionsMap.put(GroovyFunction.TYPE, GroovyFunction.class);
	}
