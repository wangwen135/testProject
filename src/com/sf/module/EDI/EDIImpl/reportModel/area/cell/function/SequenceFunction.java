...
import com.sf.module.EDI.EDIImpl.ui.function.SequenceFunctionEditor;
 ...
 * @since 1.0
 */
public class SequenceFunction extends AbstractFunction {
	...
	public String getParameterViewStr() {
		...
		strbuf.append(start);
		strbuf.append(" , ");
		strbuf.append(increment);
		strbuf.append(" , ");
		strbuf.append(maxValue);
		strbuf.append(" ");
