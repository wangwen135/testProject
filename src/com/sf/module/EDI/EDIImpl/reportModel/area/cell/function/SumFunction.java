...
import com.sf.module.EDI.EDIImpl.ui.function.SumFunctionEditor;
...
public class SumFunction extends AbstractFunction {
	...
	public String getParameterViewStr() {
		...
		strbuf.append(" ");
		strbuf.append(minFraction);
		strbuf.append(" , ");
		strbuf.append(maxFraction);
		strbuf.append(" , ");
		strbuf.append(minInteger);
		strbuf.append(" , ");
		strbuf.append(maxInteger);
		strbuf.append(" , ");
		if ("HALF_UP".equals(round)) {
			strbuf.append("四舍五入");
		} else if ("CEILING".equals(round)) {
			strbuf.append("向正无限大舍入");
		} else if ("FLOOR".equals(round)) {
			strbuf.append("向负无限大舍入");
		}
		strbuf.append(" , ");
		strbuf.append(useGroup);
		strbuf.append(" ");
