 ...
 * @since 1.0
 */
public class SumFunctionEditor extends FunctionAbstractDialog<SumFunction> {
	...
	public void viewToModel() {
		function.setMaxFraction((Integer) spn_maxFraction.getValue());
		function.setMinFraction((Integer) spn_minFraction.getValue());
		function.setMaxInteger((Integer) spn_maxInteger.getValue());
		function.setMinInteger((Integer) spn_minInteger.getValue());
		function.setRound((String) comboBox_RoundingMode.getSelectedItem());
