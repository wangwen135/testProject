 ...
 * @since 1.0
 */
public class DateFunctionEditor extends JDialog {
	...
	private DateFunctionEditor(Window windows) {
		...
		comboBox_pattern.setModel(new DefaultComboBoxModel(new String[] {
				"yyyy-MM-dd", "yyyyMMdd", "yyyy年 M月 d日", "yyyy年 MM月 dd日",
		...
		scrollPane.setBounds(0, 0, 446, 306);
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						try {
							...
							SimpleDateFormat format = new SimpleDateFormat(o
									.toString());
