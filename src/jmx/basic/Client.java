	...
	public static void main(String[] args) {
		try {
			...
			JMXServiceURL url = new JMXServiceURL(
					"service:jmx:rmi:///stub/rmi://localhost:1234/server");

			//JMXServiceURL url = new JMXServiceURL("rmi","localhost",1234);
			...
			// server connection
			//
			SimpleStandardMBean proxy = JMX.newMBeanProxy(mbsc, stdMBeanName,
