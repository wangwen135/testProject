package jmx.examples.ModelMBean;
...
/**
 * Simple definition of a ModelMBean managed application Bean, named
 * "TestBeanFriend".
 * 
 * The "TestBeanFriend" implements the same methods as "TestBean". It is used by
 * the ModelAgent test program to illustrate and demonstrate how to have
 * attributes in the same ModelMBean supported by methods on different objects.
 * 
 * This Bean exposes for management two attributes and one operation: - the
...
public class TestBeanFriend implements java.io.Serializable {
	...
	/**
	 * Getter: get the "State" attribute of the "TestBeanFriend" managed
	 * resource.
	 */
	...
	/**
	 * Setter: set the "State" attribute of the "TestBeanFriend" managed
	 * resourc.
	 */
	...
	/**
	 * Getter: get the "NbChanges" attribute of the "TestBeanFriend" managed
	 * resource.
	 */
